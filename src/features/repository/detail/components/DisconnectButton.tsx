...
export function DisconnectButton({ id, fullName }: Props) {
  ...
  return (
    <>
      <Button
        variant="outline"
        className="w-38 h-10 gap-2 border-gray-200 bg-white text-gray-700 hover:bg-red-50 hover:text-red-500 hover:border-red-200 transition-colors"
